(function($){
    var create = function(obj,settings){
        ...
        $('#query').click(function(event){
        	...
        	query['serviceSdate']=$('#serviceSdate').val();
		 	query['serviceEdate']=$('#serviceEdate').val();
		 	query['arrType']=$('#arrType').val();
			...
			$('table tr td:nth-child(10)',obj).css({'text-align':'left'});
        ...
        $('#btn_export').click(function(event){
        	...
        	query['unitNum']=$('#unitNum').val();
             ...
             var url="../../pay/exportArrearageInfos?"+keyValues.join('&');
