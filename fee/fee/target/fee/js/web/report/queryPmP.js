(function($){
    var create = function(obj,settings){
        ...
        $('#query').click(function(event){
        	...
        	var istart = $("#startDate").val();
        	var istartN = $("#startDate").attr("name");
        	var iend = $("#endDate").val();
        	var isendN = $("#endDate").attr("name");
        	...
        	query['customerId']=$('#customerId').val();
        	query['vehicleId']=$('#vehicleId').val();
        	query['unitId']=$('#unitId').val();
        	
        	query['customerName']=$('#customerName').val();
        	query['vehicleNum']=$('#vehicleNum').val();
        	query['unitNum']=$('#unitNum').val();
        	
        	query['acNo']=$('#accountNo').val();
        	query['payCtNo']=$('#payContractNo').val();
        	
        	query['payModel']=$('#payModel').val();
        	query['bwNo']=$('#bwNo').val();
        ...
        $('#btn_export').click(function(event){
        	...
        	var keyValues=[];
             ...
             var url="../../pay/exportPayments?"+keyValues.join('&');
