(function($){
    var create = function(obj,settings){
        ...
        $('#query').click(function(event){
        	...
        	query['accountNo']=$('#accountNo').val();
        	query['payContractNo']=$('#payContractNo').val();
        	query['txtName']=$('#txtName').val();
        	query['agency']=$('#agency').val();
        	query['payTag']=$('#payTag').val();
        ...
        $('#btn_export').click(function(event){
        	...
        	query['customerName']=$('#customerName').val();
             ...
             var url="../../pay/exportPaytxt?"+keyValues.join('&');
