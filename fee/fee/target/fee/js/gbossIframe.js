...
(function($){
    ...
    var createSubNode = function(json,panel,settings){
        $.each(json,function(k,v){
                ...
                var node_a = $('<a href="javascript:void(0);" class="main_nav"></a>');
                var node_img = $('<img src="">');
                var node_span = $('<span class="arrow">&gt;</span>');
                var node_div = $('<div class="sub_nav_wrap single_nav"></div>');
                var node_ul = $(' <ul class="sub_nav"></ul>');
                var node_b = $('<b></b>')
                ...
                node.append(node_a);
                node_a.addClass(v.type);
                
                var subjson = v.items;
                if(subjson&&subjson.length>0){
                    $.each(subjson,function(ky,va){
                        var subnode = $("<li></li>");
                        var sub_node_a = $('<a href="javascript:void(0);" class="cs-navi-tab">');
