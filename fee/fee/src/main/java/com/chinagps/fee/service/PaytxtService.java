...
public interface PaytxtService extends BaseService{
	...
	/**
	 * @Title:findPaytxtDtPage
	 * @Description:分页查询托收明细
	 * @param pageSelect
	 * @return
	 * @throws SystemException
	 */
	public Page<Map<String, Object>> findPaytxtDtPage(PageSelect<Map<String, Object>> pageSelect) throws SystemException;
	/**
	 * @Title:findAllPaytxtDt
	 * @Description:查询托收明细
	 * @param map
	 * @return
	 * @throws SystemException
	 */
	public List<Map<String, Object>> findAllPaytxtDt(Map<String, Object> map) throws SystemException;
